...
public class Test_Algo4 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100000; i++) {
            ...
            for (int j = 0; j < rnd; j++) {
                int rnd2 = (int) (Math.random()*100000);
...
//        double clock2 = System.currentTimeMillis();
        System.err.println("the whole program took "+(progTime/1000)+" seconds");
    }
    private static int progTime = 0;
...
//        System.out.println("shortest path distance test 3: "+res3);
        double res4 = ga0.shortestPathDist(0, x/10000);
